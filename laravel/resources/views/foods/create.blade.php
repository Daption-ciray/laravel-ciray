<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">{{ __('Yeni Yiyecek Ekle') }}</h2>
    </x-slot>
    <div class="py-12">
                ...
                <div class="p-6">
                    <form action="{{ route('foods.store') }}" method="POST">
                        ...
                        <div class="flex items-center justify-end mt-6">
                            ...
                            <button type="submit"
                                class="inline-flex items-center px-4 py-2 bg-orange-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-orange-700 transition">Kaydet</button>
                        </div>
                    </form>
                </div>
            </div>
