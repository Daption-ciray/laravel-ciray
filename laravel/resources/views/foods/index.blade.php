<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">{{ __('Yiyecekler') }}</h2>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @forelse($foods as $food)
                                <tr class="hover:bg-gray-50">
                                    <td class="px-6 py-4 text-sm text-gray-900">{{ $food->id }}</td>
                                    <td class="px-6 py-4 text-sm text-gray-900">{{ $food->name }}</td>
                                    <td class="px-6 py-4 text-sm text-gray-900">{{ $food->major }}</td>
                                    <td class="px-6 py-4 text-sm text-gray-900">{{ $food->calori }}</td>
                            ...
                            @empty
                                <tr>
                                    <td colspan="5" class="px-6 py-4 text-center text-gray-500">Henüz yiyecek
                                        bulunmamaktadır.</td>
                                </tr>
                            @endforelse
                        </tbody>
